...
const Protocol Protocol::ieee80211HePhy("ieee80211hephy", "IEEE 802.11 HE PHY", Protocol::PhysicalLayer);
const Protocol Protocol::ieee80211EhtPhy("ieee80211ehtphy", "IEEE 802.11 EHT PHY", Protocol::PhysicalLayer);
