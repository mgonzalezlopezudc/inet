...
class INET_API QosRateSelection : public IQosRateSelection, public ModeSetListener
{
  ...
  public:
    ...
    virtual const physicallayer::IIeee80211Mode *computeResponseBlockAckFrameMode(Packet *solicitingPacket, const Ptr<const Ieee80211BlockAckReq>& blockAckReq, Packet *responsePacket = nullptr) override;
