...
class INET_API QosAckHandler : public SimpleModule, public IAckHandler
{
  ...
  public:
    ...
    virtual std::set<std::pair<MacAddress, std::pair<Tid, SequenceControlField>>> processFailedBlockAckReq(const Ptr<const Ieee80211BlockAckReq>& blockAckReq);
    ...
    virtual void processTransmittedHtImplicitBlockAckFrame(const Ptr<const Ieee80211DataHeader>& header);
