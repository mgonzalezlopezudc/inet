...
class INET_API HcfPreparedTransmission
{
  private:
    HcfExchangeClass exchangeClass;
    HcfTransactionIdentity transactionIdentity;
  ...
  public:
    HcfPreparedTransmission(HcfExchangeClass exchangeClass,
            HcfTransactionIdentity transactionIdentity,
            HcfPacketIdentity packetIdentity) : exchangeClass(exchangeClass),
        transactionIdentity(transactionIdentity), packetIdentity(packetIdentity) {}
...
class INET_API HcfTransmissionResult
{
  private:
    HcfPreparedTransmission transmission;
    bool successful;

  public:
    HcfTransmissionResult(const HcfPreparedTransmission& transmission, bool successful) :
        transmission(transmission), successful(successful) {}

    const HcfPreparedTransmission& getTransmission() const { return transmission; }
    bool isSuccessful() const { return successful; }
};

class INET_API HcfResponseResult
{
  private:
    HcfExchangeClass exchangeClass;
    HcfTransactionIdentity transactionIdentity;
    HcfPacketIdentity responseIdentity;

  public:
    HcfResponseResult(HcfExchangeClass exchangeClass,
            HcfTransactionIdentity transactionIdentity,
            HcfPacketIdentity responseIdentity) : exchangeClass(exchangeClass),
        transactionIdentity(transactionIdentity), responseIdentity(responseIdentity) {}

    HcfExchangeClass getExchangeClass() const { return exchangeClass; }
    HcfTransactionIdentity getTransactionIdentity() const { return transactionIdentity; }
    HcfPacketIdentity getResponseIdentity() const { return responseIdentity; }
};

class INET_API HcfResponseTimeout
{
  private:
    HcfExchangeClass exchangeClass;
    HcfTransactionIdentity transactionIdentity;
  ...
  public:
    HcfResponseTimeout(HcfExchangeClass exchangeClass,
            HcfTransactionIdentity transactionIdentity) :
        exchangeClass(exchangeClass), transactionIdentity(transactionIdentity) {}
