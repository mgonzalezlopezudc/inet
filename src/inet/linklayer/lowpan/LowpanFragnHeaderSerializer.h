...
#ifndef __INET_LOWPANFRAGNHEADERSERIALIZER_H
#define __INET_LOWPANFRAGNHEADERSERIALIZER_H
#include "inet/common/packet/serializer/FieldsChunkSerializer.h"
namespace inet { namespace lowpan {
class INET_API LowpanFragnHeaderSerializer : public FieldsChunkSerializer
{
  protected:
