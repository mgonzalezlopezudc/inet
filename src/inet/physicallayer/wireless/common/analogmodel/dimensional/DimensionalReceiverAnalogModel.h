...
class INET_API DimensionalReceiverAnalogModel : public ReceiverAnalogModelBase, public IMultibandReceiverAnalogModel
{
  protected:
  ...
  public:
    ...
    virtual IListening *createListening(const IRadio *radio, const simtime_t startTime, const simtime_t endTime,
            const Coord& startPosition, const Coord& endPosition, const std::vector<FrequencyBand>& occupiedBands) const override;
