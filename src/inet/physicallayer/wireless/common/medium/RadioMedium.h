...
class INET_API RadioMedium : public SimpleModule, public cListener, public IRadioMedium
{
  ...
  protected:
    ...
    /**
     * The replaceable wideband channel model or nullptr if unused.
     */
    IWidebandChannelModel *channelModel;
    /**
  ...
  public:
    ...
    virtual const IWidebandChannelModel *getChannelModel() const override { return channelModel; }
