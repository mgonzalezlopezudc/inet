...
class INET_API BandListening : public ListeningBase
{
  ...
  public:
    ...
    BandListening(const IRadio *radio, simtime_t startTime, simtime_t endTime, Coord startPosition, Coord endPosition,
            const std::vector<FrequencySegment>& frequencySegments);
    ...
    virtual const std::vector<FrequencySegment>& getFrequencySegments() const { return frequencySegments; }
};
