...
class INET_API Ieee80211NistErrorModel : public Ieee80211ErrorModelBase
{
  protected:
    ...
    double get4096QamBer(double snr) const;
    ...
    double getFec4096QamBer(double snr, uint64_t nbits, uint32_t bValue) const;
    ...
    virtual double getHeDataSuccessRate(const Ieee80211HeUserPhyParameters& parameters,
            unsigned int bitLength, double snr) const override;
