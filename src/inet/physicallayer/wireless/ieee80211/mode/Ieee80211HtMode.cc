...
{
    return getHtPreDataSignalPartDurations().getDuration() + dataMode->getDuration(dataLength);
}
...
Ieee80211SignalPartDurations Ieee80211HtMode::getSignalPartDurations(b dataLength) const
{
    ...
    const auto durations = Ieee80211SignalPartDurations(preDataDurations.preambleDuration, preDataDurations.headerDuration, dataMode->getDuration(dataLength));
