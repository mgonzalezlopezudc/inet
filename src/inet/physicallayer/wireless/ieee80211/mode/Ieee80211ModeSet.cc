...
OPP_THREAD_LOCAL const DelayedInitializer<std::vector<Ieee80211ModeSet>> Ieee80211ModeSet::modeSets([]() { return new std::vector<Ieee80211ModeSet> {
    ...
    Ieee80211ModeSet("n(mixed-2.4Ghz)", {
        ...
        { true, &Ieee80211ErpOfdmCompliantModes::erpOfdmMode12Mbps, true },
        { true, &Ieee80211ErpOfdmCompliantModes::erpOfdmMode24Mbps, true }
    }, Ieee80211HtCompliantModes::getCompliantMode(&Ieee80211HtmcsTable::htMcs0BW20MHz, Ieee80211HtMode::BAND_2_4GHZ, Ieee80211HtPreambleMode::HT_PREAMBLE_MIXED, Ieee80211HtModeBase::HT_GUARD_INTERVAL_LONG), OperatingPhy::HT, true, createHtSupportedEntries(Ieee80211HtPreambleMode::HT_PREAMBLE_MIXED)),
    ...
    }, Ieee80211HtCompliantModes::getCompliantMode(&Ieee80211HtmcsTable::htMcs0BW20MHz, Ieee80211HtMode::BAND_2_4GHZ, Ieee80211HtPreambleMode::HT_PREAMBLE_GREENFIELD, Ieee80211HtModeBase::HT_GUARD_INTERVAL_LONG), OperatingPhy::HT, true, createHtSupportedEntries(Ieee80211HtPreambleMode::HT_PREAMBLE_GREENFIELD)),
    Ieee80211ModeSet("ac", {
...
Ieee80211ModeSet::Ieee80211ModeSet(const char *name, const std::vector<Entry> entries, const IIeee80211Mode *referenceMode,
        OperatingPhy operatingPhy, bool htOperationSupported, const std::vector<Entry> supportedEntries) :
    name(name),
