...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Data: QoS Data | 1737 | 38.90% | 1085.1 B | 352.6 B | 5005 MHz, 5010 MHz, 5015 MHz | -72.0 dBm | - | 86.18% | 62.32% |
| Data: QoS Null | 983 | 22.02% | 34.0 B | 0.0 B | 5002 MHz, 5003 MHz, 5004 MHz, 5006 MHz, 5010 MHz, 5013 MHz, 5017 MHz | -72.0 dBm | - | 9.69% | 7.01% |
| Control: Block Ack (BA) | 581 | 13.01% | 68.2 B | 29.5 B | 5010 MHz | - | 10.0 dBm | 1.72% | 1.24% |
| Control: Ack | 553 | 12.39% | 14.0 B | 0.0 B | 5010 MHz | -72.0 dBm | 10.0 dBm | 0.94% | 0.68% |
| Control: Trigger | 517 | 11.58% | 46.1 B | 1.8 B | 5010 MHz | - | 10.0 dBm | 1.26% | 0.91% |
| Control: Block Ack Request (BAR) | 88 | 1.97% | 24.0 B | 0.0 B | 5010 MHz | -72.0 dBm | - | 0.17% | 0.12% |
| Management: Action | 6 | 0.13% | 37.0 B | 0.0 B | 5010 MHz | -72.0 dBm | 10.0 dBm | 0.03% | 0.02% |
...
| Frame Type & Subtype | Count | Percentage | Mean Size | Std Dev | Freq | Mean RX Sig | Mean TX Pwr | Air Time % | Air Time (Sim Time) % |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Data: QoS Data | 1401 | 57.77% | 1259.1 B | 325.3 B | 5005 MHz, 5010 MHz | -72.0 dBm | - | 97.39% | 56.93% |
| Control: Ack | 828 | 34.14% | 14.0 B | 0.0 B | 5010 MHz | -72.0 dBm | 10.0 dBm | 1.75% | 1.02% |
| Control: Block Ack Request (BAR) | 92 | 3.79% | 24.0 B | 0.0 B | 5010 MHz | -72.0 dBm | - | 0.22% | 0.13% |
| Control: Block Ack (BA) | 89 | 3.67% | 148.8 B | 17.0 B | 5010 MHz | - | 10.0 dBm | 0.53% | 0.31% |
| Management: Action | 6 | 0.25% | 37.0 B | 0.0 B | 5010 MHz | -72.0 dBm | 10.0 dBm | 0.04% | 0.02% |
| Data: QoS Null | 6 | 0.25% | 34.0 B | 0.0 B | 5013 MHz, 5017 MHz | -72.0 dBm | - | 0.07% | 0.04% |
| Control: Trigger | 3 | 0.12% | 46.0 B | 0.0 B | 5010 MHz | - | 10.0 dBm | 0.01% | 0.01% |
...
| Frame Type & Subtype | Count | Percentage | Mean Size | Std Dev | Freq | Mean RX Sig | Mean TX Pwr | Air Time % | Air Time (Sim Time) % |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Data: QoS Data | 1677 | 39.36% | 1105.5 B | 347.6 B | 5005 MHz, 5010 MHz, 5015 MHz | -72.0 dBm | - | 86.64% | 61.10% |
| Data: QoS Null | 920 | 21.59% | 34.0 B | 0.0 B | 5002 MHz, 5003 MHz, 5004 MHz, 5006 MHz, 5008 MHz, 5010 MHz, 5013 MHz, 5017 MHz | -72.0 dBm | - | 9.30% | 6.56% |
| Control: Block Ack (BA) | 559 | 13.12% | 67.4 B | 29.5 B | 5010 MHz | - | 10.0 dBm | 1.68% | 1.19% |
| Control: Ack | 511 | 11.99% | 14.0 B | 0.0 B | 5010 MHz | -72.0 dBm | 10.0 dBm | 0.89% | 0.63% |
| Control: Trigger | 499 | 11.71% | 47.8 B | 6.9 B | 5010 MHz | - | 10.0 dBm | 1.27% | 0.90% |
| Control: Block Ack Request (BAR) | 89 | 2.09% | 24.0 B | 0.0 B | 5010 MHz | -72.0 dBm | - | 0.18% | 0.12% |
