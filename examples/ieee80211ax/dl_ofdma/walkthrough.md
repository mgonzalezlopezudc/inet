...
opp_scavetool query -l \
  ...
  examples/ieee80211ax/dl_ofdma/results/20260725T120411Z/*/*.sca \
  examples/ieee80211ax/dl_ofdma/results/20260725T120411Z/*/*.vec
```
...
Capture session: `results/20260725T230519Z`.
...
```sh
tshark -n -r \
  'examples/ieee80211ax/dl_ofdma/results/20260725T230519Z/EqualSizedRUs_fBW/EqualSizedRUs_fBW-#0Lan80211AxDlOfdma.ap.wlan[0].pcap' \
...
|---|---|---|---|---|
| Scalar/vector | `results/20260725T120411Z` | dashboard configs, runs 0–4 | provenance; `[0.3,0.88)` s | hashes retained in figure JSON |
| PCAP | `results/20260725T230519Z` | generated configs, run 0 | TShark 4.6.4, AP/host | manifest and hashes in generated block |
