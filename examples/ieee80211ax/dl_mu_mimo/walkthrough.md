...
```sh
bin/inet -u Cmdenv -f examples/ieee80211ax/dl_mu_mimo/omnetpp.ini \
  -c DlMuMimo -r 0 --seed-set=0 \
  --result-dir=examples/ieee80211ax/dl_mu_mimo/results/validation/dl-mu

bin/inet -u Cmdenv -f examples/ieee80211ax/dl_mu_mimo/omnetpp.ini \
  -c EqualSizedRUs_fBW -r 0 --seed-set=0 \
  --result-dir=examples/ieee80211ax/dl_mu_mimo/results/validation/dl-ofdma
```
...
opp_scavetool query -l \
  ...
  examples/ieee80211ax/dl_mu_mimo/results/20260725T120411Z/DlMuMimo/DlMuMimo-\#0.vec
```
...
```sh
tshark -n \
  -r 'examples/ieee80211ax/dl_mu_mimo/results/20260725T230510Z/UlMuMimo/UlMuMimo-#0Lan80211AxUlOfdma.ap.wlan[0].pcap' \
