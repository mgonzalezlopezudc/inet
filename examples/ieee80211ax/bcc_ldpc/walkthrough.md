...
```sh
bin/inet -u Cmdenv -f examples/ieee80211ax/bcc_ldpc/omnetpp.ini \
  -c DynamicPuncturing -r 0 \
  --result-dir="$PWD/examples/ieee80211ax/bcc_ldpc/results/manual/DynamicPuncturing"
```
...
opp_scavetool query -l \
  ...
  examples/ieee80211ax/bcc_ldpc/results/20260725T120411Z/*/*.sca \
  examples/ieee80211ax/bcc_ldpc/results/20260725T120411Z/*/*.vec
```
...
```sh
tshark -n -r \
  'examples/ieee80211ax/bcc_ldpc/results/20260725T230436Z/PreamblePuncturing/PreamblePuncturing-#0Lan80211AxHeFeatures.ap.wlan[0].pcap' \
