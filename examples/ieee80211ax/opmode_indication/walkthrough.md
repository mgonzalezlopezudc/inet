...
opp_scavetool query -l \
  ...
  examples/ieee80211ax/opmode_indication/results/20260725T120411Z/OperatingModeIndication/OperatingModeIndication-\#0.vec
```
...
```sh
tshark -n \
  -r 'examples/ieee80211ax/opmode_indication/results/20260725T230146Z/OperatingModeIndication/OperatingModeIndication-#0Lan80211AxUlOfdma.ap.wlan[0].pcap' \
  -q -z io,stat,0
```
...
|---|---|---:|---|---:|---|
| `OperatingModeIndication` | `none (all decoded frames)` | 2489 | Data: QoS Data [HE-SU, HE-MCS 1, 20 MHz, GI 3.2 us, LDPC] (1460), Control: Ack (1023), Control: Trigger (3) | 46.63% | Not delivery or de-duplicated transmissions; unknown PHY fields stay unknown |
...
Frame numbers are local to capture `OperatingModeIndication-#0Lan80211AxUlOfdma.ap.wlan[0].pcap`, not OMNeT++ event numbers. For readability, the table collapses observations with the same timestamp and MAC identity across capture interfaces; aggregate PCAP statistics retain the original observation counts.
