...
|---|---|---|---|---:|---:|---:|
| Aggressive | concurrent ap airtime percent | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 31.374 | 1.85434 |
| Aggressive | goodput mbps | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 9.78462 | 1.10803 |
| Aggressive | jain fairness | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 0.982273 | 0.0295493 |
| Color collision | concurrent ap airtime percent | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 0.904 | 0.418737 |
| Color collision | goodput mbps | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 7.90892 | 3.39826 |
| Color collision | jain fairness | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 0.887126 | 0.217623 |
| Conservative | concurrent ap airtime percent | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 7.59 | 1.36464 |
| Conservative | goodput mbps | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 8.47508 | 3.35181 |
| Conservative | jain fairness | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 0.922209 | 0.163808 |
| Disabled | concurrent ap airtime percent | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 0.904 | 0.418737 |
| Disabled | goodput mbps | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 7.90892 | 3.39826 |
| Disabled | jain fairness | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 0.887126 | 0.217623 |
| Enabled | concurrent ap airtime percent | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 24.068 | 2.02114 |
| Enabled | goodput mbps | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 9.66892 | 1.47765 |
| Enabled | jain fairness | vector / **.app[*] / packetReceived:vector(packetBytes) / unit=B<br>vector / **.ap*.wlan[0].radio / transmissionState:vector<br>vector / **.receiver / heSpatialReuseReason:vector<br>vector / **.receiver / heSpatialReuseBssType:vector<br>vector / **.receiver / heSpatialReuseEligible:vector<br>vector / **.receiver / heSpatialReuseObssPdThreshold:vector / unit=dBm<br>vector / **.receiver / heSpatialReuseTransmitPowerLimit:vector / unit=dBm | [0.3, 0.95) s; observation=per-run measurement-window aggregate; uncertainty=95% Student-t CI; validation=requires inter-BSS OBSS/PD decisions and validates the 21 dBm/-82 dBm threshold-to-power relation | 5 | 0.974458 | 0.0669148 |
...
|---:|---:|---|---|---|---|
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringCollision-#0BssColoringNetwork.ap2.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringCollision-#0BssColoringNetwork.ap2.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringCollision-#0BssColoringNetwork.ap2.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringCollision-#0BssColoringNetwork.ap2.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:5` | 0.201705000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:01 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:6` | 0.201805000 | ? → 0a:aa:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:7` | 0.201948000 | 0a:aa:00:00:00:05 → 10:00:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:8` | 0.202048000 | ? → 0a:aa:00:00:00:05 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:9` | 0.204126000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:10` | 0.204226000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringCollision-#0BssColoringNetwork.ap1.wlan[0].pcap:11` | 0.204342000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringCollision-#0BssColoringNetwork.ap2.wlan[0].pcap:12` | 0.204442000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
...
| Frame | Simulation time (s) | Transmitter → receiver | Type/PHY | Decisive fields | Role in exchange |
|---:|---:|---|---|---|---|
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringDisabled-#0BssColoringNetwork.ap2.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringDisabled-#0BssColoringNetwork.ap2.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringDisabled-#0BssColoringNetwork.ap2.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringDisabled-#0BssColoringNetwork.ap2.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:5` | 0.201705000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:01 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:6` | 0.201805000 | ? → 0a:aa:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:7` | 0.201948000 | 0a:aa:00:00:00:05 → 10:00:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:8` | 0.202048000 | ? → 0a:aa:00:00:00:05 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:9` | 0.204126000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:10` | 0.204226000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringDisabled-#0BssColoringNetwork.ap1.wlan[0].pcap:11` | 0.204342000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringDisabled-#0BssColoringNetwork.ap2.wlan[0].pcap:12` | 0.204442000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
...
| Frame | Simulation time (s) | Transmitter → receiver | Type/PHY | Decisive fields | Role in exchange |
|---:|---:|---|---|---|---|
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringEnabled-#0BssColoringNetwork.ap2.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringEnabled-#0BssColoringNetwork.ap2.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringEnabled-#0BssColoringNetwork.ap2.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringEnabled-#0BssColoringNetwork.ap2.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:5` | 0.201705000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:01 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:6` | 0.201805000 | ? → 0a:aa:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:7` | 0.201948000 | 0a:aa:00:00:00:05 → 10:00:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:8` | 0.202048000 | ? → 0a:aa:00:00:00:05 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:9` | 0.204126000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:10` | 0.204226000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `BssColoringEnabled-#0BssColoringNetwork.ap1.wlan[0].pcap:11` | 0.204342000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `BssColoringEnabled-#0BssColoringNetwork.ap2.wlan[0].pcap:12` | 0.204442000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
...
| Frame | Simulation time (s) | Transmitter → receiver | Type/PHY | Decisive fields | Role in exchange |
|---:|---:|---|---|---|---|
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `ObssPdAggressive-#0BssColoringNetwork.ap2.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdAggressive-#0BssColoringNetwork.ap2.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdAggressive-#0BssColoringNetwork.ap2.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdAggressive-#0BssColoringNetwork.ap2.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:5` | 0.201705000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:01 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:6` | 0.201805000 | ? → 0a:aa:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:7` | 0.201948000 | 0a:aa:00:00:00:05 → 10:00:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:8` | 0.202048000 | ? → 0a:aa:00:00:00:05 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:9` | 0.204126000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:10` | 0.204226000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdAggressive-#0BssColoringNetwork.ap1.wlan[0].pcap:11` | 0.204342000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdAggressive-#0BssColoringNetwork.ap2.wlan[0].pcap:12` | 0.204442000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
...
| Frame | Simulation time (s) | Transmitter → receiver | Type/PHY | Decisive fields | Role in exchange |
|---:|---:|---|---|---|---|
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `ObssPdConservative-#0BssColoringNetwork.ap2.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdConservative-#0BssColoringNetwork.ap2.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdConservative-#0BssColoringNetwork.ap2.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdConservative-#0BssColoringNetwork.ap2.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:5` | 0.201705000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:01 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:6` | 0.201805000 | ? → 0a:aa:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:7` | 0.201948000 | 0a:aa:00:00:00:05 → 10:00:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:8` | 0.202048000 | ? → 0a:aa:00:00:00:05 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:9` | 0.204126000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:10` | 0.204226000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `ObssPdConservative-#0BssColoringNetwork.ap1.wlan[0].pcap:11` | 0.204342000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `ObssPdConservative-#0BssColoringNetwork.ap2.wlan[0].pcap:12` | 0.204442000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
...
| Frame | Simulation time (s) | Transmitter → receiver | Type/PHY | Decisive fields | Role in exchange |
|---:|---:|---|---|---|---|
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `TwoNav-#0BssColoringNetwork.ap2.wlan[0].pcap:1` | 0.201236000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `TwoNav-#0BssColoringNetwork.ap2.wlan[0].pcap:2` | 0.201336000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:01 → 0a:aa:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `TwoNav-#0BssColoringNetwork.ap2.wlan[0].pcap:3` | 0.201452000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:05 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:01 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `TwoNav-#0BssColoringNetwork.ap2.wlan[0].pcap:4` | 0.201552000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:5` | 0.201705000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:01 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:6` | 0.201805000 | ? → 0a:aa:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:7` | 0.201948000 | 0a:aa:00:00:00:05 → 10:00:00:00:00:02 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:8` | 0.202048000 | ? → 0a:aa:00:00:00:05 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:9` | 0.204126000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Data: QoS Data / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=from DS, retry=0, seq=0, frag=0, more-frag=0, TID=6 | Carries protocol-visible MAC payload in the representative exchange. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:10` | 0.204226000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
| `TwoNav-#0BssColoringNetwork.ap1.wlan[0].pcap:11` | 0.204342000 | 10:00:00:00:00:02 → 0a:aa:00:00:00:06 | Management: Action / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- | Provides frame-order context for the representative exchange. |
| `TwoNav-#0BssColoringNetwork.ap2.wlan[0].pcap:12` | 0.204442000 | ? → 10:00:00:00:00:02 | Control: Ack / HE-SU, HE-MCS 0, 20 MHz, NSS 1, GI 3.2 us, LDPC | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- | Acknowledges the preceding unicast frame. |
