...
- Scalar/vector: `20260809T142140Z`
- PCAP: `20260809T142140Z`
...
![dl_mu_mimo_baseline scalar/vector analysis](results/20260809T142140Z/dl-mu-mimo-baseline-delivery-delay.png)

Figure provenance: [`results/20260809T142140Z/dl-mu-mimo-baseline-delivery-delay.png.json`](results/20260809T142140Z/dl-mu-mimo-baseline-delivery-delay.png.json). Run-level metric source: [`../../ieee80211ax/analysis/metrics.json`](../../ieee80211ax/analysis/metrics.json).
...
![802.11 Packet Type Statistics](results/20260809T142140Z/packet_statistics.png)

Figure provenance: [`packet_statistics.png.json`](results/20260809T142140Z/packet_statistics.png.json).

This section provides a statistical overview of the 802.11 frames transmitted over the wireless medium during the simulation. The packet counts were gathered from AP wireless-interface observation points. With multiple AP captures, one medium transmission may be observed at more than one AP; counts and airtime therefore represent recorded transmission observations, not de-duplicated application packets.

Capture session `20260809T142140Z` was generated from fresh PCAPng input with `TShark (Wireshark) 4.6.4.`. The selected manifest is `examples/ieee80211/analysis/generated/ac/capture_manifests/20260809T142140Z.json` (SHA-256 `b434ff1db4569748374bb332e002829173928ae7955190644cf7b0886b00b96f`). VHT PPDU format, MCS, coding, bandwidth, GI, and NSTS are decoded directly from standards-compliant radiotap VHT fields; values not marked known by the recorder are omitted.
...
| `VhtDlMuMimoThreeUsers` | `none (all decoded frames)` | 2032 | Control: Block Ack Request (BAR) (590), Control: Block Ack (BA) (590), VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] (588) | 91.72% | Not delivery or de-duplicated transmissions; unknown PHY fields stay unknown |
...
|---|---|---|
| **PASS** | VhtDlMuMimoThreeUsers produced protocol-visible wireless observations | 2032 AP/global transmission observations |
...
Total over-the-air frame/MPDU transmission observations (Global BSS/AP): **2032**

<small>

| Color | Frame Type & Subtype | BSS Color | Count | Percentage | Mean Size | Std Dev | Mean Duration | Std Dev Duration | Freq | Mean RX Sig | Mean TX Pwr | Air Time % | Air Time (Sim Time) % |
|:---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | - | 109 | 5.36% | 1000.8 B | 225.3 B | 142.6 us | 23.1 us | 5010 MHz | - | 13.0 dBm | 1.70% | 1.55% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#17a625" /></svg> | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC] | - | 36 | 1.77% | 1024.4 B | 520.7 B | 145.1 us | 53.4 us | 5010 MHz | - | 13.0 dBm | 0.57% | 0.52% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | - | 588 | 28.94% | 1044.6 B | 137.2 B | 1412.8 us | 182.9 us | 5010 MHz | - | 13.0 dBm | 90.57% | 83.07% |
| <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | Control: Block Ack Request (BAR) | - | 590 | 29.04% | 24.0 B | 0.0 B | 28.0 us | 0.0 us | 5010 MHz | - | 13.0 dBm | 1.80% | 1.65% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | Control: Block Ack (BA) | - | 22 | 1.08% | 32.0 B | 0.0 B | 30.7 us | 0.0 us | 5010 MHz | -54.9 dBm | - | 0.07% | 0.07% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | Control: Block Ack (BA) | - | 590 | 29.04% | 152.0 B | 0.0 B | 70.7 us | 0.0 us | 5010 MHz | -58.0 dBm | - | 4.55% | 4.17% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#4799eb" /></svg> | Control: Ack | - | 9 | 0.44% | 14.0 B | 0.0 B | 24.7 us | 0.0 us | 5010 MHz | -58.3 dBm | 13.0 dBm | 0.02% | 0.02% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#4799eb" /></svg> | Control: Ack | - | 34 | 1.67% | 14.0 B | 0.0 B | 24.7 us | 0.0 us | 5010 MHz | -61.9 dBm | - | 0.09% | 0.08% |
| <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ec1313" /></svg> | Management: Action No Ack: VHT: VHT Compressed Beamforming | - | 15 | 0.74% | 201.0 B | 0.0 B | 288.0 us | 0.0 us | 5010 MHz | -58.3 dBm | - | 0.47% | 0.43% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ec1313" /></svg> | Management: Action: Block Ack: ADDBA Req | - | 3 | 0.15% | 37.0 B | 0.0 B | 69.3 us | 0.0 us | 5010 MHz | - | 13.0 dBm | 0.02% | 0.02% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ec1313" /></svg> | Management: Action: Block Ack: ADDBA Resp | - | 3 | 0.15% | 37.0 B | 0.0 B | 69.3 us | 0.0 us | 5010 MHz | -58.3 dBm | - | 0.02% | 0.02% |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ec1313" /></svg> | Management: Action: VHT: Group ID Management | - | 3 | 0.15% | 54.0 B | 0.0 B | 92.0 us | 0.0 us | 5010 MHz | - | 13.0 dBm | 0.03% | 0.03% |
| <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#82cc33" /></svg> | A-MPDU Delimiter / Aggregation Overhead | - | 15 | 0.74% | 0.0 B | 0.0 B | 20.0 us | 0.0 us | 26 MHz | - | - | 0.03% | 0.03% |
| <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> | <hr> |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#fad233" /></svg> | Control: NDP Announcement (NDPA) | - | 15 | 0.74% | 23.0 B | 0.0 B | 27.7 us | 0.0 us | 5010 MHz | - | 13.0 dBm | 0.05% | 0.04% |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 36 | 0.210278000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=1, frag=0, more-frag=0, TID=0, A-MPDU=2654435905 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 37 | 0.210278000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=1, frag=0, more-frag=0, TID=0, A-MPDU=1013903498 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 39 | 0.210594000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654435905 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 41 | 0.210910000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013903498 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 42 | 0.220060000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=2, frag=0, more-frag=0, TID=0, A-MPDU=1148 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 43 | 0.220108000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1148 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 44 | 0.220296000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=2, frag=0, more-frag=0, TID=0, A-MPDU=2654436621 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 45 | 0.220296000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=2, frag=0, more-frag=0, TID=0, A-MPDU=1013905350 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 47 | 0.220612000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654436621 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 49 | 0.220928000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013905350 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 50 | 0.230060000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=3, frag=0, more-frag=0, TID=0, A-MPDU=1336 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 51 | 0.230108000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1336 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 52 | 0.230242000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=3, frag=0, more-frag=0, TID=0, A-MPDU=2654436553 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 53 | 0.230242000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=3, frag=0, more-frag=0, TID=0, A-MPDU=1013904898 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 55 | 0.230558000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654436553 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 57 | 0.230874000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013904898 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 58 | 0.240060000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=4, frag=0, more-frag=0, TID=0, A-MPDU=1524 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 59 | 0.240108000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1524 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 60 | 0.240350000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=4, frag=0, more-frag=0, TID=0, A-MPDU=2654437269 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 61 | 0.240350000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=4, frag=0, more-frag=0, TID=0, A-MPDU=1013904734 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 63 | 0.240666000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654437269 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 65 | 0.240982000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013904734 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 66 | 0.250060000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=5, frag=0, more-frag=0, TID=0, A-MPDU=1712 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 67 | 0.250108000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1712 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 68 | 0.250287000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=5, frag=0, more-frag=0, TID=0, A-MPDU=2654437201 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 69 | 0.250287000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=5, frag=0, more-frag=0, TID=0, A-MPDU=1013904794 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 71 | 0.250603000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654437201 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 73 | 0.250919000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013904794 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 74 | 0.260060000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=6, frag=0, more-frag=0, TID=0, A-MPDU=1900 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 75 | 0.260108000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1900 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 76 | 0.260242000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=6, frag=0, more-frag=0, TID=0, A-MPDU=2654436893 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 77 | 0.260242000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=6, frag=0, more-frag=0, TID=0, A-MPDU=1013904598 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 79 | 0.260558000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654436893 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 81 | 0.260874000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013904598 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 82 | 0.270060000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=7, frag=0, more-frag=0, TID=0, A-MPDU=2088 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 83 | 0.270108000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2088 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 84 | 0.270296000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=7, frag=0, more-frag=0, TID=0, A-MPDU=2654433753 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 85 | 0.270296000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=7, frag=0, more-frag=0, TID=0, A-MPDU=1013906194 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 87 | 0.270612000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654433753 |
...
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 89 | 0.270928000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013906194 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 90 | 0.300152000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=8, frag=0, more-frag=0, TID=0, A-MPDU=2282 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 91 | 0.300200000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2282 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 92 | 0.300497000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=8, frag=0, more-frag=0, TID=0, A-MPDU=2654433409 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 93 | 0.300497000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=8, frag=0, more-frag=0, TID=0, A-MPDU=1013905994 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 94 | 0.300497000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=9, frag=0, more-frag=0, TID=0, A-MPDU=3668337683 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 95 | 0.300569000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 96 | 0.300813000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654433409 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 97 | 0.300885000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 98 | 0.301129000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013905994 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 99 | 0.301201000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 100 | 0.301445000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=3668337683 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#fad233" /></svg> | 101 | 0.301616000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | Control: NDP Announcement (NDPA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#f9ee1f" /></svg> | 102 | 0.301684000 | ? → ? | Control: VHT Sounding NDP [NDP Sounding] | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ec1313" /></svg> | 103 | 0.301992000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Management: Action No Ack: VHT: VHT Compressed Beamforming | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 104 | 0.302208000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=9, frag=0, more-frag=0, TID=0, A-MPDU=2654434075 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 105 | 0.302208000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=15, frag=0, more-frag=0, TID=0, A-MPDU=1013905872 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 106 | 0.302208000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=15, frag=0, more-frag=0, TID=0, A-MPDU=3668338569 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 107 | 0.302280000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 108 | 0.302524000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654434075 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 109 | 0.302596000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 110 | 0.302840000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013905872 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 111 | 0.302912000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:03 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 112 | 0.303157000 | 0a:aa:00:00:00:03 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=3668338569 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#fad233" /></svg> | 113 | 0.303382000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | Control: NDP Announcement (NDPA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#f9ee1f" /></svg> | 114 | 0.303450000 | ? → ? | Control: VHT Sounding NDP [NDP Sounding] | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ec1313" /></svg> | 115 | 0.303758000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Management: Action No Ack: VHT: VHT Compressed Beamforming | direction=direct/IBSS, retry=0, seq=0, frag=0, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 1550 | 0.500002000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654459259 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 1551 | 0.500074000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 1552 | 0.500319000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013866416 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 1553 | 0.500572000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=197, frag=0, more-frag=0, TID=0, A-MPDU=2654459115 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 1554 | 0.500572000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=196, frag=0, more-frag=0, TID=0, A-MPDU=1013866016 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 1555 | 0.500644000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 1556 | 0.500888000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654459115 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 1557 | 0.500960000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 1558 | 0.501204000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013866016 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 1559 | 0.501538000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=198, frag=0, more-frag=0, TID=0, A-MPDU=2654458995 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 1560 | 0.501538000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=197, frag=0, more-frag=0, TID=0, A-MPDU=1013866168 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 1561 | 0.501610000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 1562 | 0.501854000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654458995 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 1563 | 0.501926000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 1564 | 0.502170000 | 0a:aa:00:00:00:02 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=1013866168 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 1565 | 0.502396000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=199, frag=0, more-frag=0, TID=0, A-MPDU=2654459899 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#29c224" /></svg> | 1566 | 0.502396000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | VHT MU QoS Data [VHT, VHT-MCS 8, 20 MHz, GI 0.8 us, BCC, A-MPDU] | direction=from DS, retry=0, seq=198, frag=0, more-frag=0, TID=0, A-MPDU=1013865776 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 1567 | 0.502468000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:01 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#0946c8" /></svg> | 1568 | 0.502712000 | 0a:aa:00:00:00:01 → 10:00:00:00:00:00 | Control: Block Ack (BA) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=-, A-MPDUs acknowledged=2654459899 |
| <svg width="16" height="16"><rect width="16" height="16" rx="3" fill="#ab6c30" /></svg> | 1569 | 0.502784000 | 10:00:00:00:00:00 → 0a:aa:00:00:00:02 | Control: Block Ack Request (BAR) | direction=direct/IBSS, retry=0, seq=-, frag=-, more-frag=0, TID=- |
...
| 101 | 0.301616000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:01 | 4 | VHT | AID=1, Feedback=MU, Nc=4 |
| 113 | 0.303382000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:02 | 5 | VHT | AID=2, Feedback=MU, Nc=4 |
| 125 | 0.305138000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:03 | 6 | VHT | AID=3, Feedback=MU, Nc=4 |
| 848 | 0.402842000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:01 | 7 | VHT | AID=1, Feedback=MU, Nc=4 |
| 860 | 0.404536000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:02 | 8 | VHT | AID=2, Feedback=MU, Nc=4 |
| 872 | 0.406328000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:03 | 9 | VHT | AID=3, Feedback=MU, Nc=4 |
| 1577 | 0.504138000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:01 | 10 | VHT | AID=1, Feedback=MU, Nc=4 |
| 1586 | 0.505625000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:02 | 11 | VHT | AID=2, Feedback=MU, Nc=4 |
| 1595 | 0.506985000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:03 | 12 | VHT | AID=3, Feedback=MU, Nc=4 |
| 1946 | 0.607520000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:03 | 13 | VHT | AID=3, Feedback=MU, Nc=4 |
| 1951 | 0.608571000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:01 | 14 | VHT | AID=1, Feedback=MU, Nc=4 |
| 1970 | 0.611811000 | 10:00:00:00:00:00 | 0a:aa:00:00:00:02 | 15 | VHT | AID=2, Feedback=MU, Nc=4 |
...
| 102 | 0.301684000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 114 | 0.303450000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 126 | 0.305206000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 849 | 0.402910000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 861 | 0.404604000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 873 | 0.406396000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 1578 | 0.504206000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 1587 | 0.505693000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 1596 | 0.507053000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 1947 | 0.607588000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 1952 | 0.608639000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
| 1971 | 0.611879000 | - | - | VHT Sounding NDP | VHT | 20 MHz | 4 | 0.8 us | BCC |
