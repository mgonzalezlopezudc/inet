...
| **VHT Rate Adaptation** | [`vht_rate_adaptation`](vht_rate_adaptation/walkthrough.md) | Dynamic VHT rate control using `Ieee80211VhtMinstrel` under mobile channel conditions (`FixedVhtMcs`, `VhtMinstrelAdaptation`). |
