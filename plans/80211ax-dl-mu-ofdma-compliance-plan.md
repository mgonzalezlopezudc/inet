...
The core compliance work was implemented in commit `bc14642e7f` on branch
`topic/80211heulmuofdma`. The focused HE/DL unit-test suite passes and the
OFDMA validation scenario runs successfully.
