...
* `inet-simulation-run`: establish the run command, NED path, INET library, environment, and release/debug mode.
...
Use `inet-cmdenv-log-analysis` for module decisions and `omnetpp-eventlog-analysis` for simulator scheduling or message causality.
...
Record the run/seed and the packet, flow, time interval, or event that identifies the exchange. Discover only the relevant instantiated module paths and effective parameters: radio/medium and channel conditions for PHY questions; management, addressing, QoS, protection, retry, aggregation, and acknowledgment policies for MAC questions.
...
* [scope-and-reproducibility.md](references/scope-and-reproducibility.md): instantiated-interface inspection, feature gates, and reproducible comparisons.
...
* [evidence-tools.md](references/evidence-tools.md): 802.11-specific capture fields, evidence interpretation, and source searches.
* [lldb-80211-breakpoints.md](references/lldb-80211-breakpoints.md): 802.11-specific breakpoint targets.
